<x-app-layout>
    ...
    <section class="bg-gray-300 py-2">
        <div class="container mx-auto grid grid-cols-1 gap-4 lg:gap-16 mt-2 lg:grid-cols-2 xl:grid-cols-4">
            <!-- Visitas -->
            <div class="flex items-center shadow justify-between p-2 bg-white rounded-md">
                <div>
