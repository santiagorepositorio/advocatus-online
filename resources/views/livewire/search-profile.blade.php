<form class="pt-2 relative mx-auto text-gray-600" autocomplete="off">
    ...
    type="search" name="search" placeholder="Escribe el nombre del Perfil Profesional que busca">
    ...
    <ul class="absolute z-50 left-0 w-full bg-white mt-1 rounded-lg overflow-hidden">
        ...
        <li class="leading-10 px-5 text-sm cursor-pointer hover:bg-gray-300"><a href="{{ route('profiles.show', $result) }}">{{ $result->name }}</a></li>
        @empty
