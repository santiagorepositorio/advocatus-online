    ...
    <div class="grid grid-cols-3 divide-x divide-gray-200">
                            ...
                            <li class="cursor-pointer" wire:click="open_chat_contact({{ $contact }})">
                                <div class="flex">
                                    <figure class="flex-shrink-0">
                                        @if ($contact->user_phone == null)
                                            <img class="h-12 w-12 object-cover object-center rounded-full"
                                                src="{{ asset('assets/imgs/profile.png') }}"
                                                alt="{{ $contact->wa_id }}">
                                        @else
                                            <img class="h-12 w-12 object-cover object-center rounded-full"
        ...
        <div class="col-span-2">
            @if ($contactChat)
                ...
                <div class="bg-gray-200 h-16 flex items-center px-3">
                    <figure>
                        @if ($contactChat->user_phone == null)
                            <img class="w-10 h-10 rounded-full object-cover object-center"
                                src="{{ asset('assets/imgs/profile.png') }}" alt="{{ $contactChat->wa_id }}">
                        @else
                            <img class="w-10 h-10 rounded-full object-cover object-center"
                                src="{{ $contactChat->user->profile_photo_url }}"
                                alt="{{ $contactChat->user->name }}">
                        @endif
