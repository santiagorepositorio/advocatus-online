<div class="container py-8">
    <x-table-responsive>
        ...
        <div class="px-6 py-4 flex">
            ...
            <a class="btn btn-danger ml-2" href="{{ route('instructor.publicities.create') }}">Crear Publicidad</a>
        </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                                <div class="relative h-10 w-10">
                                    @isset($publicitie->image)
                                        <img class="h-full w-full rounded-full object-cover object-center"
                                            src="{{ Storage::url($publicitie->image->url) }}" alt="" />
                                    @else
                                        <img class="h-full w-full rounded-full object-cover object-center"
                                ...
                                <div class="text-sm">
                                    <div class="font-medium text-gray-700">{{ $publicitie->title }}</div>
                                    <div class="text-gray-400">{{ $publicitie->created_at }}</div>
                                </div>
                            </th>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-end gap-4">
                                    ...
                                    <a x-data="{ tooltip: 'Edite' }" href="{{ route('instructor.publicities.edit', $publicitie) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="h-6 w-6"
                                            x-tooltip="tooltip">
                                            <path stroke-linecap="round" stroke-linejoin="round"
