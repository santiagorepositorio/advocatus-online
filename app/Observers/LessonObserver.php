...
class LessonObserver
{
    public function creating(Lesson $lesson)
    {
        ...
        if ($platform_id == 1) {
            ...
            // $lesson->iframe = '<iframe width="560" height="315" src="https://www.youtube.com/embed/nnuhgPkN64o"frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
            ...
            $array = preg_match($patron, $url, $parte);
            // $lesson->iframe = '<iframe src="https://player.vimeo.com/video/67120236?h=ef08cabc8b" width="640" height="360" frameborder="0"    allowfullscreen></iframe>';
