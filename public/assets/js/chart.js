...
!(function (t, e) {
    ...
    function Oe(t, e, i, n, o) {
        ...
        return (
            De(t, i, e, function (i, l, c) {
                ...
                const d = s(e, h);
                d < a
                    ? ((r = [{ element: i, datasetIndex: l, index: c }]),
                      (a = d))
                    : d === a &&
    ...
    var Ae = {
        modes: {
            ...
            nearest: (t, e, i, n) =>
                Oe(t, Se(e, t), i.axis || "xy", i.intersect, n),
    ...
    function Ue(t, e) {
        ...
        for (s = 0, a = t.length; s < a; ++s) {
            ...
            r.horizontal
                ? ((r.width = c ? c * n : a && e.availableWidth),
                  (r.height = o))
                : ((r.width = n),
    ...
    class wn {
        ...
        applyStack(t, e, i) {
            const n = this.chart,
                ...
                s = e[t.axis];
            return fn(
                { keys: un(n, !0), values: e._stacks[t.axis] },
                s,
                o.index,
                { mode: i }
            );
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return (
                g.$shared &&
                    ((g.$shared = l), (s[a] = Object.freeze(vn(g, l)))),
                g
            );
        }
                ...
                d + 6 > a &&
                    ...
                    (c = It(
                        Math.min(
                            ...
                            Math.asin(Ht(r / l, -1, 1)) -
                                Math.asin(Ht(u / l, -1, 1))
                        )
                    )),
            ...
            !1 !== e.notifyPlugins("beforeDatasetDraw", a) &&
                (o &&
                    Zt(i, {
                        ...
                        bottom:
                            !1 === n.bottom ? e.height : s.bottom + n.bottom,
                    }),
                t.controller.draw(),
                o && Qt(i),
                (a.cancelable = !1),
    ...
    class bo extends wn {
        ...
        _calculateBarValuePixels(t) {
            ...
            if (
                ((h = e.chart.getDataVisibility(t)
                    ? i.getPixelForValue(f + g)
                    : m),
                (d = h - m),
                Math.abs(d) < s &&
                    ((d =
                        ...
                        (s = u
                            ? Ht(
                                  Math.max(
                                      ...
                                      i
                                          ? 0
                                          : se(e, l, a.getPixelForValue(h)).hi +
                                                1
                                  ),
                                  o,
                                  n
    ...
    var bs = {
        ...
        beforeDraw(t, e, i) {
            ...
            for (let e = o.length - 1; e >= 0; --e) {
                const i = o[e].$filler;
                i &&
                    (i.line.updateControlPoints(s, i.axis),
                    n && xs(t.ctx, i, s));
            }
        },
    ...
    class Fs extends Mn {
        ...
        getTitle(t, e) {
            ...
            let r = [];
            return (
                (r = Ds(r, Cs(o))), (r = Ds(r, Cs(s))), (r = Ds(r, Cs(a))), r
            );
        }
        getBeforeBody(t, e) {
            ...
            const o = (function (t, e) {
                ...
                for (
                    ...
                    (d && v !== s
                        ? (i.push({ value: s }),
                          v < s && P++,
                          At(Math.round((v + P * k) * y) / y, s, Hs(s, _, t)) &&
                              P++)
                        : v < s && P++);
                    P < M;
                    ++P
            ...
            return (
                ...
                (t._majorUnit =
                    n.major.enabled && "year" !== t._unit
                        ? (function (t) {
                              for (
                                  let e = na.indexOf(t) + 1, i = na.length;
                                  e < i;
                                  ++e
                              )
